...
- **Local knowledge base**
  ...
  - **scan health panel** — compact coverage dashboard showing 7-day/30-day scan counts, latest scan age, consecutive-day streak, and a tiered status indicator (Good / Fair / Poor) with configurable thresholds (min scans for Good, max age for Good/Poor tiers); settings persist locally with reset-to-defaults; toggleable from the integrity report header
